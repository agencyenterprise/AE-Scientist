...
class Stage3Plotting(Stage):
    ...
    DEFAULT_GOALS: ClassVar[str] = (
        ...
        "- Test your models on multiple datasets from appropriate sources to demonstrate generalization. Use dataset sizes appropriate to the experiment. Usually THREE datasets are enough."
    )

    ...
    def draft(agent: "MinimalAgent") -> Node:
        ...
        instructions |= {
            "Experiment design sketch guideline": [
                ...
                "Use real public datasets appropriate to the task. If the research idea specifies dataset URLs or names, use those. Otherwise, research where suitable datasets are available (common sources: HuggingFace, Zenodo, GitHub, UCI ML Repository, academic repositories, etc.). Only fall back to synthetic data if no suitable dataset is available or synthetic generation is essential to the experiment.",
                "",
            ],

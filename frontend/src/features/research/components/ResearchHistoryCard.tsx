      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex flex-col items-end gap-2">
          <Link
            ...
            className="inline-flex items-center gap-1.5 rounded-full border border-sky-500/30 bg-sky-500/10 px-4 py-2 text-xs font-semibold text-sky-200 transition hover:border-sky-500/50 hover:bg-sky-500/20"
          >
            {isCompleted ? "Relaunch experiment" : "View experiment"}
          </Link>
        </div>
      </div>
    </article>

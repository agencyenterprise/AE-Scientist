...
export type StageId = import("./api.gen").components["schemas"]["StageId"];
export type ExperimentalStageId = import("./api.gen").components["schemas"]["ExperimentalStageId"];
...
type StageSummaryStreamEvent = {
  type: "stage_summary";
  data: import("./research").StageSummary;
};
type HwCostEstimateEvent = import("./research").HwCostEstimateEvent;
type HwCostActualEvent = import("./research").HwCostActualEvent;
type TerminationStatusStreamEvent = import("./research").TerminationStatusStreamEvent;
export type ResearchRunStreamEvent =
  | ApiResearchRunStreamEvent
  | HwCostEstimateEvent
  | HwCostActualEvent
  | StageSummaryStreamEvent
  | TerminationStatusStreamEvent;

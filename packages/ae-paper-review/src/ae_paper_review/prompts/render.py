"""Jinja2 template rendering using importlib.resources for package templates."""
...
def _env() -> Environment:
    """Create Jinja2 environment with package resource loader."""
    return Environment(
        loader=PackageResourceLoader("ae_paper_review.prompts"),
